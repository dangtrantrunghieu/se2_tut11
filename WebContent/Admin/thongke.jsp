...
<html>
  <head>
  <title>Thống Kê | Admin HANU-Homeware</title>
...
<link href='http://fonts.googleapis.com/css?family=Open+Sans'
	...
	%>
      ...
      function drawChart() {
    	...
    	%>
        var options = {
          title: 'THỐNG KÊ DOANH THU HANU-Homeware'
        };
...
<title>Thống Kê Doanh Thu | Admin HANU-Homeware</title>
  ...
  var tr;
	...
	/* $("#submit").click(function(){ */
		...
		/* if(flag==0){
			$.ajax({
				type: "GET",
				url: "/HANU_Homeware/ThongKeServlet",
				data: {
					action: "Thongke",
					datebd : datebd,
					datekt : datekt 
